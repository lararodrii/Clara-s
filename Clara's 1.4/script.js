document.addEventListener('DOMContentLoaded', function () {
    ...
    eventTimeInput.addEventListener('input', validateTimeAndAvailability);
    eventDurationInput.addEventListener('change', validateTimeAndAvailability);
        ...
        fetch(scriptURL, {
            ...
            .then(data => {
                if (data.status === 'success') {
                    ...
                    alert('Agendamento salvo! Você será redirecionado para o WhatsApp para finalizar.');
                    form.reset();
                    bookingModal.style.display = "none";
                } else {
            ...
            // --- Substitua o bloco .catch atual por este ---
